...
def plot_prediction(yolo_pose_detection_config, biometric_trait, reference_image, predicted_image, acquisition_name):
    """
    ...
    prediction_plots_dir = os.path.join(yolo_pose_detection_config.save_path, biometric_trait, "yolo_pose", "test", "plots", "prediction plots")
    ...
    if yolo_pose_detection_config.save_image.plot_prediction:
        plt.savefig(prediction_plots_path)

    plt.close()

    if yolo_pose_detection_config.show_image.plot_prediction:
