...
def plot_prediction(detection_yolo_config, biometric_trait, reference_image, predicted_image, acquisition_name):
    """
    ...
    prediction_plots_dir = os.path.join(detection_yolo_config.save_path, biometric_trait, "yolo", "test", "plots", "prediction plots")
    ...
    if detection_yolo_config.save_image.plot_prediction:
        plt.savefig(prediction_plots_path)

    plt.close()

    if detection_yolo_config.show_image.plot_prediction:
