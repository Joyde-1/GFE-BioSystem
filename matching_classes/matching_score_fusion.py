...
class MatchingScoreFusion:
    ...
    def _compare_templates(self, gait_template1, face_template1, ear_dx_template1, ear_sx_template1,
        ...
        weighted_ear_dx_score = ear_dx_score * self.multimodal_config.score_fusion.weight_ear
        weighted_ear_sx_score = ear_sx_score * self.multimodal_config.score_fusion.weight_ear
