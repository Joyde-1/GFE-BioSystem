...
class MatchingMultimodal:
    ...
    def _compare_templates(self, template1, template2):
        ...
        Ritorna:
            float: distanza (score) tra i due template. Valori minori indicano una maggiore somiglianza.
        """
        if self.multimodal_config.matching_algorithm == 'chi-square':
            return self._chi_square(template1, template2)
        elif self.multimodal_config.matching_algorithm == 'euclidean':
    ...
    def calculate_far(self, subjects):
        ...
        with open(self.multimodal_config.results_path + f"/multimodal_results_FAR", "w") as file:
                ...
                for i in range(num_acquisizioni):
                    ...
                    for other_subject in subjects:
                        ...
                        for j in range(len(other_templates)):
                            ...
                            if matching_score < self.multimodal_config.matching.threshold:
                                FA += 1
    ...
    def calculate_frr(self, subjects):
        ...
        # Opening the text file to save the matching results
        with open(self.multimodal_config.results_path + f"/multimodal_results_FRR", "w") as file:
            # Per ogni soggetto
            for subject in subjects:
                templates = subjects[subject]['template']
    ...
    def calculate_roc_and_det(self, subjects):
        ...
        plt.savefig(self.multimodal_config.results_path + f"/multimodal_ROC.png")
        plt.close()
        ...
        # Salva il grafico
        plt.savefig(self.multimodal_config.results_path + f"/multimodal_DET.png")
        plt.close()
    ...
    def far_vs_frr(self, subjects):
        ...
        self.multimodal_config.matching.threshold = original_threshold
        ...
        # Salva il grafico
        plt.savefig(self.multimodal_config.results_path + f"/multimodal_far_vs_frr.png")
        plt.close()