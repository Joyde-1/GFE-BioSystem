...
# MULTIMODAL CLASSES
from features_fusion_face_ear.pca import FeaturesFusionPCA


if __name__ == '__main__':
    # LOAD CONFIG FILES
    multimodal_config = load_config('config/multimodal_config_face_ear.yaml')
    ...
    # far, fa, t_imp = multimodal_score_fusion_matching.calculate_far(subjects['face'], subjects[f'ear_{ear_side}'])
    # frr, fr, t_legit = multimodal_score_fusion_matching.calculate_frr(subjects['face'], subjects[f'ear_{ear_side}'])
    ...
    # multimodal_score_fusion_matching.calculate_roc_and_det(subjects['face'], subjects[f'ear_{ear_side}'])
    # multimodal_score_fusion_matching.far_vs_frr(subjects['face'], subjects[f'ear_{ear_side}'])