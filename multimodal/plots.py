...
from multimodal.utils import save_image
...
def plot_principal_components(multimodal_config, cumulative_variance_explained, optimal_components):
    """
    ...
    if multimodal_config.save_images.plot_pca_cumulative_variance:
        figure_path = save_image(None, multimodal_config, "", file_suffix="pca_cumulative_variance")
